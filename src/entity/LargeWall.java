...
public class LargeWall extends Entity implements Armored, Health, Large{
	public final Chunk[][] chunks;
	public final Rectangle box;
	public LargeWall(int x, int y, Chunk chunk, String sprite, Rectangle box) {
	...
	public LargeWall(int x, int y, Chunk chunk, String sprite, int x1, int y1, int x2, int y2) {
		super(x, y, chunk, sprite);
...
//		Point brc = Tools.nav.absPointToChunkPoint(box.b);
		...
		*/
		Chunk[][] temp = Chunk.loadChunks(Tools.nav.absPointToChunkPoint(box.a), chunks.length, chunks[0].length);
